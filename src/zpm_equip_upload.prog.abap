...
*&   Date             :                              *
*&   Company          : UEP                                         *
*&   Program Name     : ZPM_EQUIP_UPLOAD                     *
*&   LDB Used         :                                                *
*&**********************************************************************
*& Program Definition : This program is to upload the Text on Equipment.          *
*                                                                      *
*&                            ()                             *
*&**********************************************************************
...
*&          I            I              I                              *
*&+-------------------------------------------------------------------+*
REPORT ZPM_EQUIP_UPLOAD.

INCLUDE ZPM_EQUIP_UPLOAD_T01.
*INCLUDE ZPM_PRIDE_TEMPLATE_UPLOAD_T01.
INCLUDE ZPM_EQUIP_UPLOAD_S01.
*INCLUDE ZPM_PRIDE_TEMPLATE_UPLOAD_S01.
INCLUDE ZPM_EQUIP_UPLOAD_F01.
