...
TYPES: BEGIN OF TY_PRIDE.
         INCLUDE TYPE ZPM_PRIDE_RDET_T.
TYPES EQUNR TYPE EQUNR.
TYPES END OF TY_PRIDE.


DATA: LS_PRIDE_DATA TYPE TY_PRIDE. "Work Area for LS_IMRG table"
